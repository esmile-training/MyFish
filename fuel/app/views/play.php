...
<?php endfor; ?>
		...
		<?php // プレイヤーの駒を表示する   ?>
<div id="piece">
	<div id="piece_1_1" class="piece_size" onclick="get_piece_data(this.id)">
		<?= Asset::img('chara/chara_p1.png', array('class' => 'piece_size', 'alt' => 'player')) ?>
	</div>

	<div id="piece_1_2" onclick="get_piece_data(this.id)">
		<?= Asset::img('chara/chara_p1.png', array('class' => 'piece_size', 'alt' => 'player')) ?>
	</div>

	<div id="piece_2_1" onclick="get_piece_data(this.id)">
		<?= Asset::img('chara/chara_p2.png', array('class' => 'piece_size', 'alt' => 'player')) ?>
	</div>

	<div id="piece_2_2" onclick="get_piece_data(this.id)">
		<?= Asset::img('chara/chara_p2.png', array('class' => 'piece_size', 'alt' => 'player')) ?>
	</div>

	<div id="piece_3_1" onclick="get_piece_data(this.id)">
		<?= Asset::img('chara/chara_p3.png', array('class' => 'piece_size', 'alt' => 'player')) ?>
	</div>

	<div id="piece_3_2" onclick="get_piece_data(this.id)">
		<?= Asset::img('chara/chara_p3.png', array('class' => 'piece_size', 'alt' => 'player')) ?>
	</div>

	<div id="piece_4_1" onclick="get_piece_data(this.id)">
		<?= Asset::img('chara/chara_p4.png', array('class' => 'piece_size', 'alt' => 'player')) ?>
	</div>

	<div id="piece_4_2" onclick="get_piece_data(this.id)">	
<?= Asset::img('chara/chara_p4.png', array('class' => 'piece_size', 'alt' => 'player')) ?>
	</div>
</div>
